...
if (!fs.existsSync(process.cwd() + '/FCA')) {
    fs.mkdirSync(process.cwd() + '/FCA');
    fs.writeFileSync(process.cwd() + '/FCA/README.md', 'Chào', 'utf8');
}
var db = new BetterDB(process.cwd() + "/FCA/tthinh.sqlite");
